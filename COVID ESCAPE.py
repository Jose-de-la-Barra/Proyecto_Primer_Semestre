...
class InstructionView(arcade.View):
    ...
    def __init__(self):
        super().__init__()
        self.texture = arcade.load_texture("media/images/screens/Instrucciones.jpg")
...
class MyGame(arcade.View):
    ...
    def setup(self):  # inicializar las listas
        ...
        self.player_sprite.stand_right_textures.append(arcade.load_texture("media/images/player/adventurer_stand.png"))

        self.player_sprite.stand_left_textures = []
        self.player_sprite.stand_left_textures.append(arcade.load_texture("media/images/player/adventurer_stand.png", mirrored=True))

        self.player_sprite.walk_right_textures = []
        self.player_sprite.walk_right_textures.append(arcade.load_texture("media/images/player/adventurer_walk1.png"))
        self.player_sprite.walk_right_textures.append(arcade.load_texture("media/images/player/adventurer_walk2.png"))

        self.player_sprite.walk_left_textures = []
        self.player_sprite.walk_left_textures.append(arcade.load_texture("media/images/player/adventurer_walk1.png", mirrored=True))
        self.player_sprite.walk_left_textures.append(arcade.load_texture("media/images/player/adventurer_walk2.png", mirrored=True))
        ...
        # AMBIENTE
        sol = "media/images/objects/sun1.png"
        ...
        letrero = "media/images/objects/sign.png"
        ...
        for k in range(len(piedra_x)):
            piedra = "media/images/objects/rock.png"
        ...
        for i in range(800, 1500, 150):
            pasto = arcade.Sprite("media/images/texture/grass.png", escala_sol)
            pasto.center_x = i
            pasto.center_y = 937

        # CREAR VIRUS
        virus = Virus("media/images/virus/virus.png", escala_virus)  # hereda las características de la clase Virus
        virus.center_x = 1107
        virus.center_y = 105
        self.virus_list.append(virus)

        # Segundo virus
        virus2 = Virus2("media/images/virus/virus2.png", escala_virus2)  # hereda las características de la clase Virus
        ...
        for i in range(320, 470, 64):
            piso = arcade.Sprite("media/images/texture/grassMid.png", escala_piso)
            piso.center_x = i
            piso.center_y = 32
        ...
        for i in range(510, 710, 64):
            piso = arcade.Sprite("media/images/texture/waterTop_high.png", escala_piso)
            piso.center_x = i
            piso.center_y = 32
        ...
        while n <= 192:
            for k in range(0, 800, 64):
                pared = arcade.Sprite("media/images/texture/grassCenter.png", escala_piso)
        ...
        for p in range(-64, 256, 64):
            piso = arcade.Sprite("media/images/texture/grassCenter.png", escala_piso)
            piso.center_x = p
            piso.center_y = 32
            self.pisos_list.append(piso)
            self.wall_list.append(piso)
        ...
        for p in range(len(descenso)):
            piso = arcade.Sprite("media/images/texture/grassHill_left.png", escala_piso)
        ...
        for p in range(len(esquinas)):
            piso = arcade.Sprite("media/images/texture/grassCorner_left.png", escala_piso)
        ...
        n = 1
        cosas = ["media/images/objects/alcohol_gel.png", "media/images/objects/guantes.png", "media/images/objects/mascara.png"]
        cte_eje_y = 50
        while n <= 11:
            ...
            for p in cordenadas_lista:
                pisoaire = arcade.Sprite("media/images/texture/ground_grass_small_broken.png", escala_pisovolador)
                pisoaire.position = p
        ...
        cont = 0
        for i in range(2):
            letrero_flecha = "media/images/objects/signRight.png"
        ...
        for i in range(94, 1080, 80):
            muralla = arcade.Sprite("media/images/texture/columna.png", escala_piso)
        ...
        for i in range(1350, 1930, 64):
            piso = arcade.Sprite("media/images/texture/stoneMid.png", escala_piso)
            piso.center_x = i
            piso.center_y = 32
            self.pisos_list.append(piso)
            self.wall_list.append(piso)
        ...
        for i in range(1940, 2140, 64):
            lava = arcade.Sprite("media/images/texture/lavaTop_high.png", escala_piso)
            lava.center_x = i
            lava.center_y = 32
        ...
        for i in range(2586, 2750, 64):
            piso2 = arcade.Sprite("media/images/texture/stoneMid.png", escala_piso)
            piso2.center_x = i
            piso2.center_y = 224
        ...
        for i in range(2586, 2750, 64):
            piso = arcade.Sprite("media/images/texture/stoneCenter.png", escala_piso)
            piso.center_x = i
            piso.center_y = 160
            self.pisos_list.append(piso)
            self.wall_list.append(piso)
        ...
        for p in range(len(acenso)):
            piso = arcade.Sprite("media/images/texture/stoneHill_right.png", escala_piso)
        ...
        for p in range(len(esquinas2)):
            piso = arcade.Sprite("media/images/texture/stoneCorner_right.png", escala_piso)
        ...
        while n <= 192:
            for k in range(0, 800, 64):
                pared = arcade.Sprite("media/images/texture/stoneCenter.png", escala_piso)
        ...
        while n <= 11:
            ...
            for p in cordenadas_lista:
                pisoaire = arcade.Sprite("media/images/texture/ground_stone_small_broken.png", escala_pisovolador)
                pisoaire.position = p
                self.pisos_list.append(pisoaire)
                self.wall_list.append(pisoaire)  # el piso flotante no se puede atravesar
                n += 1
        ...
        for i in range(8):
            ...
            if o == "media/images/obects/alcohol_gel.png":
                material = arcade.Sprite(o, escala_gel)
                material.position = k[0], k[1] + cte_eje_y
                self.objetos_list.append(material)
            elif o == "media/images/obects/guantes.png":
                material = arcade.Sprite(o, escala_guantes)
                material.position = k[0], k[1] + cte_eje_y
                self.objetos_list.append(material)
            elif o == "media/images/obects/mascara.png":
                material = arcade.Sprite(o, escala_mask)
                material.position = k[0], k[1] + cte_eje_y
                self.objetos_list.append(material)
        ...
        Audio().solo_una_vez("media/audio/TheVirusIsComing.mp3")
...
#        arcade.draw_text(score_text, 10, 10, arcade.csscolor.WHITE, 18)
    ...
    def on_key_press(self, key, modifiers):  # se llama cada vez que presionamos una tecla
        ...
        if key == arcade.key.UP:
            if self.physics_engine.can_jump():
                ...
                salto.solo_una_vez("media/audio/salto.mp3")
    ...
    def on_update(self, delta_time):  # Actualización
        ...
        for objetos in objetos_hit_list:
            ...
            Audio().solo_una_vez("media/audio/Recoger.mp3")
        ...
        for objetos in vacunas_hit_list:
            ...
            objetos.remove_from_sprite_lists()
            # Hace un sonido al "tomar" el objeto
            Audio().solo_una_vez("media/audio/vacuna.mp3")
            self.score += 1  # Agrega uno al puntaje

            Audio().solo_una_vez("media/audio/Gokillthevirus.mp3")
        ...
        if self.score == 10 and virus_hit:
            Audio().solo_una_vez("media/audio/TheSeconVirusIsComing.mp3")
            Audio().solo_una_vez("media/audio/boing.mp3")
        ...
        if self.score == 8:  # para que aparezca la vacuna
            ...
            vacuna = arcade.Sprite("media/images/obects/VACUNA.png", 0.1)
            vacuna.position = k[0], k[1] + 50
            self.vacuna_list.append(vacuna)
            Audio().solo_una_vez("media/audio/LookForTheVaccine.mp3")
            self.score = 9
        ...
        if self.score == 18:  # para que aparezca la vacuna
            ...
            vacuna2 = arcade.Sprite("media/images/obects/VACUNA.png", 0.1)
        ...
        if (self.score < 10) and virus_hit:
            view = GameOverView("media/images/screens/game-over.jpg")
            ...
            view = Ventana_Ganador("media/images/screens/WINNER.jpg")
            Audio().solo_una_vez("media/audio/boing.mp3")
            self.window.show_view(view)
        ...
        if agua_hit:
            time.sleep(.3)
            view = GameOverView("media/images/screens/looser-agua.jpg")
            self.window.show_view(view)
        ...
        if lava_hit:
            time.sleep(.3)
            view = GameOverView("media/images/screens/looser-lava.jpg")
            self.window.show_view(view)
...
class Audio:
    ...
    def solo_una_vez(self, archivo_audio):
        ...
        if archivo_audio == "media/audio/Musica_ganador.mp3" or archivo_audio == "media/audio/vacuna.mp3" or archivo_audio == "media/audio/salto.mp3" or\
                archivo_audio == "media/audio/Recoger.mp3" or archivo_audio == "media/audio/cancion.mp3":
...
class GameOverView(arcade.View):
    ...
    def __init__(self, archivo_de_imagen):
        ...
        Audio().solo_una_vez("media/audio/GameOver.mp3")
...
class Ventana_Ganador(arcade.View):
    ...
    def __init__(self, archivo_de_imagen):
        ...
        super().__init__()
        self.texture = arcade.load_texture(archivo_de_imagen)
        Audio().solo_una_vez("media/audio/YouWin.mp3")
...
Audio().solo_una_vez("media/audio/cancion.mp3")
